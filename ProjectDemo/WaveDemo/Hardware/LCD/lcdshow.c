...
{ 
	...
	for(t=0;t<distance+1;t++)
	{
        ...
        for(i=40;i<90;i++)
        {
            LCD_DrawPoint(uRow+1,i,BLACK);//画点
        }
...
*   返回值：    无
*/
void LCD_ShowUI(void)
{
    LCD_Fill(0,0,160,128,BLACK);
    static uint8_t title[] = {0xBC,0xF2,0xD2,0xD7,0xCA,0xBE,0xB2,0xA8,0xC6,0xF7,0x00};
    LCD_ShowChinese(40,0,title,BLACK,GREEN,16,0);
}
